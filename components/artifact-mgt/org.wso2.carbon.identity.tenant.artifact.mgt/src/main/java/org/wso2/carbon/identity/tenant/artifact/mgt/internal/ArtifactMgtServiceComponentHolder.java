 ...
 */
public class ArtifactMgtServiceComponentHolder {

    private static ArtifactMgtServiceComponentHolder instance = new ArtifactMgtServiceComponentHolder();
    ...
    private ArtifactMgtServiceComponentHolder(){
    }

    public static ArtifactMgtServiceComponentHolder getInstance() {
