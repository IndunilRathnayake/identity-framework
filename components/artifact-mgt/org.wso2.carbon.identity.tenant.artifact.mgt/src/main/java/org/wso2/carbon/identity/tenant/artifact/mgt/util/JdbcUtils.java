...
package org.wso2.carbon.identity.tenant.artifact.mgt.util;
import org.wso2.carbon.database.utils.jdbc.JdbcTemplate;
import org.wso2.carbon.database.utils.jdbc.exceptions.DataAccessException;
import org.wso2.carbon.identity.core.persistence.JDBCPersistenceManager;

import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.DB2;
import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.H2;
import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.INFORMIX;
import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.MICROSOFT;
import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.MY_SQL;
import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.POSTGRES_SQL;
import static org.wso2.carbon.identity.tenant.artifact.mgt.ArtifactMgtConstants.S_MICROSOFT;
...
public class JdbcUtils {
    ...
    public static boolean isH2MySqlOrPostgresDB() throws DataAccessException {
        ...
        return isDBTypeOf(MY_SQL) || isDBTypeOf(H2) || isDBTypeOf(POSTGRES_SQL);
    }
