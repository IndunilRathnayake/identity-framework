...
import static org.wso2.carbon.identity.application.mgt.ApplicationMgtDBQueries.LOAD_SP_TEMPLATE_CONTENT;
...
public class ApplicationTemplateDAOImpl implements ApplicationTemplateDAO {
    ...
    public List<String> getAllApplicationTemplateNames(String tenantDomain)
        ...
        try {
            ...
            throw new IdentityApplicationManagementException(String.format("Error while loading application template "
