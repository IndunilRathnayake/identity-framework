...
public interface ApplicationTemplateDAO {
     ...
     * @throws IdentityApplicationManagementException
     */
    List<SpTemplateDTO> getAllApplicationTemplates(String tenantDomain) throws IdentityApplicationManagementException;
     ...
     * @throws IdentityApplicationManagementException
     */
    List<String> getAllApplicationTemplateNames(String tenantDomain) throws IdentityApplicationManagementException;
