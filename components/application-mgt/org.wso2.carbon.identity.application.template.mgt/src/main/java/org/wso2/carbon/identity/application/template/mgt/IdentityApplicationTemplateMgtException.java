...
/**
 * Custom exception to be thrown inside Service Provider Template related functionality.
 */
public class IdentityApplicationTemplateMgtException extends Exception {
