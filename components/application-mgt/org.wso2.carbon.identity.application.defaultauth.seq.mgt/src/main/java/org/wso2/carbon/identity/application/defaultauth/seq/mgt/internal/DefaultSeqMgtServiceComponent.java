...
public class DefaultSeqMgtServiceComponent {
    private static final Log log = LogFactory.getLog(DefaultSeqMgtServiceComponent.class);
    ...
    protected void setRegistryService(RegistryService registryService) {
        ...
        DefaultSeqMgtServiceComponentHolder.getInstance().setRegistryService(registryService);
    }
    ...
    protected void unsetRegistryService(RegistryService registryService) {
        ...
        DefaultSeqMgtServiceComponentHolder.getInstance().setRegistryService(null);
    }
    ...
    protected void setRealmService(RealmService realmService) {
        ...
        DefaultSeqMgtServiceComponentHolder.getInstance().setRealmService(realmService);
    }
    ...
    protected void unsetRealmService(RealmService realmService) {
        ...
        DefaultSeqMgtServiceComponentHolder.getInstance().setRealmService(null);
    }
    ...
    protected void setConfigurationContextService(ConfigurationContextService configContextService) {
        ...
        DefaultSeqMgtServiceComponentHolder.getInstance().setConfigContextService(configContextService);
    }
    ...
    protected void unsetConfigurationContextService(ConfigurationContextService configContextService) {
        ...
        DefaultSeqMgtServiceComponentHolder.getInstance().setConfigContextService(null);
    }
    ...
    protected void setArtifactManagementService(ArtifactManagementService artifactManagementService) {

        DefaultSeqMgtServiceComponentHolder.getInstance().setArtifactManagementService(artifactManagementService);
    }

    protected void unsetArtifactManagementService(ArtifactManagementService artifactManagementService) {

        DefaultSeqMgtServiceComponentHolder.getInstance().setArtifactManagementService(null);
    }
}
