...
public abstract class DefaultAuthenticationSeqMgtService {
     ...
     */
    public static DefaultAuthenticationSeqMgtService getInstance() {
        return DefaultAuthenticationSeqMgtServiceImpl.getInstance();
    }
