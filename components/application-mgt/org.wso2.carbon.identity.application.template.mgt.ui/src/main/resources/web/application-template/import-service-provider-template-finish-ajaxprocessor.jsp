...
<%@ page import="org.wso2.carbon.identity.application.template.mgt.ui.client.ApplicationTemplateManagementServiceClient"%>
...
<%
    ...
    if (StringUtils.isNotEmpty(content)) {
        try {
            ...
            spTemplateDTO.setDescription(templateDescription);
            spTemplateDTO.setSpContent(content);
            serviceClient.importApplicationTemplate(spTemplateDTO);
%>
    <script>
        location.href = 'list-service-provider-template.jsp';
    </script>
<%
        } catch (Exception e) {
...
%>
    <script>
        location.href = 'add-service-provider-template.jsp';
    </script>
<%
        }
    } else {
