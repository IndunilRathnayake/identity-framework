 ...
 */
public class ResourceMgtServiceComponentHolder {

    private static ResourceMgtServiceComponentHolder instance = new ResourceMgtServiceComponentHolder();
    ...
    private ResourceMgtServiceComponentHolder(){
    }

    public static ResourceMgtServiceComponentHolder getInstance() {
