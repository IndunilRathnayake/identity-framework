...
public class DefaultClaimFilterTest {
    ...
    public void setRequestedClaimsInRequest() throws Exception {
        ...
        localClaim.setClaimUri(personIDLocalClaimUri);
        remoteClaim = new Claim();
        remoteClaim.setClaimUri(personIDRemoteClaimUri);
    ...
    public void setSpClaimMappings() throws Exception {
        ...
        claimMapping = new ClaimMapping();
        localClaim = new Claim();
        localClaim.setClaimUri(legalPersonIdLocalClaimUri);
        remoteClaim = new Claim();
        remoteClaim.setClaimUri(legalPersonIdRemoteClaimUri);
        claimMapping.setLocalClaim(localClaim);
        claimMapping.setRemoteClaim(remoteClaim);
        claimMapping.setRequested(true);
        claimMapping.setMandatory(true);
